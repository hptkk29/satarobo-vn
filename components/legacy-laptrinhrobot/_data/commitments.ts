...
export const commitments: Commitment[] = [
  ...
  { id: 3, icon: "Plane", title: "Giải thưởng du lịch 3-7 triệu", description: "Học viên đạt giải cuộc thi cấp thành phố được thưởng chuyến du lịch 3-7 triệu kết hợp khai trương tháng 8/2026." },
