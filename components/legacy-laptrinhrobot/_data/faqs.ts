...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: [
      "Phụ huynh có thể liên hệ Zalo hoặc gọi 0837.812.860 — một số duy nhất cho cả hai cơ sở — để được tư vấn nhanh về khóa học, lớp phù hợp, cơ sở gần nhà và lịch học còn chỗ.",
