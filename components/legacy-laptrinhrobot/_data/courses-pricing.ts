...
export const courseGroups: CourseGroup[] = [
  {
    ...
    courses: [
      withDuration({ id: "Sata1", name: "Robosim Master", shortName: "Sata1 - Robosim Master", displayName: "Robosim Master", hook: "Làm chủ vòng loại RoboSim", groupName: "Khóa luyện thi", educationLevel: "Tiểu học, Trung học cơ sở", grade: "Lớp 3-8", sessions: 11, device: "RoboSim phần mềm", format: "Trực tiếp, kết hợp E-learning", listPrice: 1650000, earlyBirdPrice: 1485000, earlyBirdOutside: 1485000, pricePerSession: 150000, badge: "Luyện thi RoboSim", note: "Dành cho học sinh cần luyện thi vòng loại, làm quen phần mềm RoboSim, đọc sa bàn và tối ưu chiến thuật bài thi. Lưu ý: 5 buổi đầu là buổi học thử miễn phí, không tính vào học phí.", value: "Sata1 - Robosim Master - Lớp 3-8 - 11 buổi - 90 phút/buổi - Tổng 16,5 giờ - Giá ưu đãi 1.485.000đ" }),
