...
export const courseGroups: CourseGroup[] = [
  {
    ...
    courses: [
      ...
      withDuration({ id: "Combo", name: "Combo Sata1 + Sata2", shortName: "Combo Sata1 + Sata2", displayName: "Full Lộ Trình Luyện Thi", hook: "Học trọn từ RoboSim đến robot Beta", grade: "Lớp 1-8", sessions: 27, device: "RoboSim phần mềm + Robot Beta thật", format: "Trực tiếp, kết hợp E-learning", listPrice: 4690000, comboPrice: 3986000, savedAmount: 704000, pricePerSession: 147000, badge: "Combo đề xuất", note: "Bao gồm Robosim Master + Đấu trường Robot cho phụ huynh muốn con học trọn lộ trình luyện thi từ RoboSim đến robot Beta.", value: "Combo Sata1 + Sata2 - Lớp 1-8 - 27 buổi - 90 phút/buổi - Tổng 40,5 giờ - Giá combo 3.986.000đ" }),
