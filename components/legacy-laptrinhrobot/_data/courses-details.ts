...
export const courseDetails: Record<string, CourseDetail> = {
  sata1: {
    ...
    metaDescription:
      "Khóa Robosim Master 11 buổi cho lớp 1-8. Làm chủ phần mềm Robosim bắt buộc trong cuộc thi Sáng tạo Robotics 2026. Ưu đãi 10% còn 1.485.000đ.",
    ...
    mission:
      "Robosim là phần mềm BẮT BUỘC trong cuộc thi Sáng tạo Robotics 2026 do Thành Đoàn Đà Nẵng tổ chức. Sata Robo là đơn vị duy nhất tại Đà Nẵng đào tạo bài bản phần mềm này. Trong 11 buổi học, con được luyện trực tiếp trên các sa bàn đề thi vòng loại, rèn tư duy thuật toán cùng kỹ năng tối ưu chiến thuật bài thi.",
    outcomes: [
    ...
    highlights: [
      "11 buổi × 90 phút = 16,5 giờ luyện thi tập trung",
  ...
  "combo-sata1-sata2": {
    ...
    metaDescription:
      "Trọn bộ 27 buổi: Robosim Master + Đấu trường Robot. Lộ trình bài bản từ vòng loại đến chung kết. Tiết kiệm 15% còn 3.986.000đ (147.000đ/buổi).",
    audienceTag: "Học sinh Lớp 1-8",
    audienceDescription:
      "Combo đề xuất cho phụ huynh muốn con có lộ trình LUYỆN THI HOÀN CHỈNH — từ phần mềm Robosim đến vận hành robot Beta thật.",
    mission:
      "Combo Sata1+Sata2 là lộ trình tiết kiệm và bài bản nhất cho học viên có mục tiêu thi đấu nghiêm túc. 27 buổi liên thông từ kỹ năng Robosim cơ bản đến vận hành robot Beta cấp khu vực. Tiết kiệm 704.000đ so với mua riêng từng khóa.",
    outcomes: [
