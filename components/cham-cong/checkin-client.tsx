...
// components/cham-cong/checkin-client.tsx — nút Check-in/Check-out sau khi quét QR.
// DÙNG CHUNG cho admin (`/cham-cong/checkin`) và site GV (`/teacher/cham-cong/checkin`);
// dời từ `app/(admin)/admin/cham-cong/checkin/_components/` ở L0 (05/09/2026).
// shadcn/Tailwind thuần — không Magic UI/Motion (chạy trong cả hai khu).
