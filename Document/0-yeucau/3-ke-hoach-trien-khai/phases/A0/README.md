...
|---|---|---|---|---|---|---|---|
| A0-00 | [Test infra](A0-00-test-infra.md) | P0 | 2d | — | 4 | 2/4 | 🟡 harness DONE (typecheck/lint ✓, 6 spec list ✓) · chạy e2e chờ máy có Docker; seedOrg/seedRoles chờ A0-01/02 |
| A0-01 | [OrgUnit](A0-01-orgunit.md) | P0 | 5d | 00 | 8 | 13/24 | 🟡 domain (29 ✓) + DB layer DONE (authored: model+migration+service+seed+11 e2e; typecheck/lint/validate ✓) · chạy e2e chờ Docker |
...
| A0-05 | [Common login](A0-05-common-login.md) | P0 | 3d | 03 | 7 | 9/14 | TODO |
