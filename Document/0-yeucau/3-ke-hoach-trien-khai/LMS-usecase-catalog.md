...
> 🔗 **Evidence/use-case** cho bản chốt [`04-LMS-master-fix-plan.md`](./04-LMS-master-fix-plan.md). (Audit trên `full-R7` **pre-merge**.)
>
...
| A3 | Điều chỉnh thanh toán | Bút toán âm `adjustmentOfId` | exc: **thiếu chặn `amount≤0`** → CHECK DB throw thô (bản 04 W2-2) | ⚠️ | `payment.ts:257` |
