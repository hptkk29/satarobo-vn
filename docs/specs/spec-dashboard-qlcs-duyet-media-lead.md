...
|---|---|---|
| C-06 | Đánh dấu rớt | Trạng thái `Rớt` đặt theo **TỪNG CON**; **bắt buộc nhập lý do** — ô **ghi chú tự do**, đặt ở cấp phụ huynh (`Lead.lostNote`/`lostAt`). ⚠️ Danh mục lý do (enum) **ĐÃ BỎ** theo quyết định 24/08 mục 12(b); đánh đổi đã chấp nhận: không còn báo cáo "top lý do rớt" |
