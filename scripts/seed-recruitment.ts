...
const POSITIONS: JobSeed[] = [
  {
    ...
    location: "danang",
    type: "fulltime",
    salary: "Lương cứng + hoa hồng theo SR.QD.200",
    salaryNote: "Lương cứng + hoa hồng theo SR.QD.200",
...
258 Lê Thanh Nghị, Hòa Cường, Đà Nẵng (Trụ sở chính). T2 - T7: 8:00 - 20:00.`,
    requirements: mdList([
  ...
  },
  {
    ...
    location: "danang",
    type: "fulltime",
    salary: "Đơn giá buổi dạy + lương cơ bản (SR.QD.210)",
    salaryNote: "Đơn giá buổi dạy + lương cơ bản theo SR.QD.210",
    description: `## Mô tả công việc
...
269 Điện Biên Phủ, Thanh Khê, Đà Nẵng. T2 - T7: linh hoạt theo lịch đào tạo.`,
    requirements: mdList([
  ...
  },
  {
    ...
    location: "danang",
    type: "fulltime",
    salary: "Theo SR.QD.200 - thoả thuận",
    salaryNote: "Theo SR.QD.200, Bậc 4-6 tuỳ kinh nghiệm",
    description: `## Mô tả công việc

Đảm bảo toàn bộ nghĩa vụ tài chính - kế toán - thuế của Sata Robo đúng quy định pháp luật. Tỷ lệ phụ trách: Kế toán tổng hợp ~65% / Hành chính NS ~35%.
...
258 Lê Thanh Nghị, Hòa Cường, Đà Nẵng. T2 - T7: 8:00 - 17:00.`,
    requirements: mdList([
  ...
  },
  {
    ...
    location: "danang",
    type: "fulltime",
    salary: "Lương + thưởng KPI lead/CPL",
    salaryNote: "SR.QD.200 + thưởng KPI (CPL, leads, conversion)",
    description: `## Mô tả công việc

Chịu trách nhiệm toàn diện về hiệu quả Paid Ads (Facebook/TikTok/Google) - trọng tâm tạo lead chất lượng cao với CPL tối ưu. Phối hợp xây dựng kênh nội dung (Fanpage, TikTok, YouTube).
...
258 Lê Thanh Nghị, Hòa Cường, Đà Nẵng. T2 - T7: 8:00 - 17:00.`,
  ...
  },
  {
    ...
    location: "danang",
    type: "fulltime",
    salary: "Lương cứng + hoa hồng theo doanh số",
    salaryNote: "Lương cứng + hoa hồng % theo doanh thu",
    description: `## Mô tả công việc

Khai thác và chuyển đổi data khách hàng tiềm năng (phụ huynh học sinh) thành đơn hàng thực tế qua điện thoại / Zalo / chat. Hoàn thành chỉ tiêu doanh thu tháng.
...
258 Lê Thanh Nghị, Hòa Cường, Đà Nẵng. T2 - T7: 8:00 - 17:00.`,
  ...
  },
  {
    ...
    location: "danang",
    type: "intern",
    salary: "Trợ cấp 2-3 triệu/tháng + thưởng project",
    salaryMin: 2_000_000,
    salaryMax: 3_000_000,
    salaryNote: "Trợ cấp 2.000.000 - 3.000.000 VNĐ/tháng + thưởng project",
    description: `## Mô tả công việc

Hỗ trợ triển khai marketing đa kênh (Facebook, TikTok, YouTube), ứng dụng AI vào sản xuất nội dung, thiết kế hình ảnh và làm video. Rèn luyện kỹ năng thực chiến.
...
258 Lê Thanh Nghị, Hòa Cường, Đà Nẵng. Linh hoạt 4-6h/ngày, ít nhất 3 ngày/tuần.`,
    requirements: mdList([
...
async function main() {
  console.log("🚀 Seeding 6 JobPosting records (Phase 4.UI.RESET.2)...\n");

  for (const pos of POSITIONS) {
    const result = await db.jobPosting.upsert({
      where: { slug: pos.slug },
      update: {
        title: pos.title,
        ...
        salary: pos.salary,
        salaryMin: pos.salaryMin ?? null,
        salaryMax: pos.salaryMax ?? null,
        salaryNote: pos.salaryNote ?? null,
        status: "OPEN",
      },
      create: {
        slug: pos.slug,
  ...
  const total = await db.jobPosting.count({ where: { status: "OPEN" } });
  console.log(`\n📊 Total OPEN JobPosting: ${total}`);
}
