  ...
  it("buildPeriodWorkbook: 3 sheet, mã NV ép chuỗi, lưới có đủ cột ngày", async () => {
    ...
    const wb = buildPeriodWorkbook({
      ...
      summary: {
        ...
        rows: [{ userId: "u", name: "A", employeeCode: "0012", jobTitle: "GV", units: 1.5, expectedUnits: 2, leaveUnits: 0, holidayPaidUnits: 0, hourCredit: 0, workedMinutes: 300, expectedMinutes: 450, lateCount: 1, lateMinutes: 12, earlyLeaveCount: 0, earlyLeaveMinutes: 0, workedDays: 1, scheduledDays: 2, missingTapDays: 0, overrideDays: 1, flaggedDays: 1, teachingSessions: 3, noiQuy: { caQuyDinh: 2, caThucTe: 1, soLanTre: 1, ngayKhongPhep: 0, ngayChoKetLuan: 0, phanTramTru: 0.5 }, grid: { "2026-09-01": "S", "2026-09-02": "P" }, unitsByDay: { "2026-09-01": 1, "2026-09-02": 0.5 } }],
