// Khung chờ của màn Phân loại buổi — cùng hình với nội dung thật (tiêu đề → tab module → tab cấu hình →
// thanh công cụ → bảng 8 cột), để chuyển tab không nháy trắng rồi nhảy.
