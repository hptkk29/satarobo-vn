...
export function SurveyAdmin({
  ...
  const inputCls = "w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-primary focus:outline-none";
            ...
            {surveys.map((s) => (
              <li key={s.id} className="flex items-center justify-between gap-2 py-2">
                ...
                <button type="button" disabled={pending}
                  ...
                  className={`rounded-full px-2.5 py-0.5 text-xs font-semibold ${s.isActive ? "bg-state-success-soft text-state-success-ink" : "bg-gray-100 text-gray-500"}`}>
