        ...
        <div className="flex flex-wrap gap-1.5">
          {statuses.map((s) => (
            <button
              ...
              className={`rounded-full border px-2.5 py-1 text-xs ${ selStatuses.includes(s) ? "border-primary-dark bg-primary-soft text-primary" : "border-neutral-300 text-neutral-500" }`}
            >
              {s}
            </button>
          ))}
