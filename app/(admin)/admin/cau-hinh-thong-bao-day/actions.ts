...
import { setGlobalSetting, type SetResult } from "@/lib/settings/service";
import { catalogPrefixes } from "@/lib/notifications/catalog";

/**
 * Lưu danh sách loại thông báo được đẩy Web Push.
 *
...
export async function luuLoaiDuocDayAction(input: {
  ...
  if (res.ok) {
    revalidatePath("/admin/cau-hinh-thong-bao-day");
    // Màn Cấu hình vận hành in chính khoá này ở ô JSON — không xoá cache của nó thì hai màn
    // hiện hai giá trị khác nhau, và người dùng tin màn nào cũng đều có lý.
