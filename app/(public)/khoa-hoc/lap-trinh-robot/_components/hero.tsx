...
const centerIcons = [MapPin, Building2, MapPin, Home] as const
            ...
            <div className="mx-auto mb-5 max-w-full rounded-3xl border border-primary-orange/25 bg-white/95 p-4 text-left shadow-card sm:max-w-2xl sm:p-5 lg:mx-0">
              <div className="space-y-3 text-sm leading-relaxed text-text-dark sm:text-base">
                ...
                <p>
                  ...
                  <Highlight tone="purple">tư duy công nghệ</Highlight>:{' '}
                  <Highlight>lập trình, robotics</Highlight>.
                </p>
                <div className="rounded-2xl border border-primary-purple/20 bg-soft-purple px-4 py-3 text-sm font-black text-primary-purple sm:text-base">
                  Toán học rèn tư duy. Công nghệ mở thế giới.
                </div>
                <p>
                  <Highlight tone="purple">Với lộ trình 5 năm</Highlight> bài bản cho con từ{' '}
                  <Highlight>lớp 1 đến lớp 8</Highlight>. Bố mẹ hãy cho con bắt đầu{' '}
                  <Highlight tone="purple">HỌC NGAY — TỪ HÔM NAY</Highlight> ở các trung tâm tại Đà Nẵng.
                </p>
              </div>
            </div>

            <div className="flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              <a href="#registration-form" className="btn-primary w-full sm:w-auto text-sm sm:text-base">
                Đăng ký học trải nghiệm miễn phí
              </a>
              <a href="#roadmap" className="btn-outline w-full sm:w-auto text-sm sm:text-base">
                Xem lộ trình học
              </a>
            </div>
          </div>
          ...
          <div className="min-w-0">
            <div className="overflow-hidden rounded-[1.75rem] bg-gradient-orange-purple px-5 pt-5 shadow-2xl sm:px-8 sm:pt-7">
              <div className="relative flex min-h-[210px] items-end justify-center sm:min-h-[280px] lg:min-h-[320px]">
                ...
                <Image
                  ...
                  width={310}
                  height={420}
                  className="relative z-10 object-contain drop-shadow-2xl animate-float"
                  style={{ width: '68%', maxWidth: '310px', height: 'auto' }}
                  priority
                />
              </div>
            </div>
            ...
            <div className="relative z-20 mx-2 -mt-5 rounded-[1.35rem] border border-primary-orange/20 bg-white/95 p-4 shadow-xl backdrop-blur sm:mx-4">
              <div className="mb-3 flex items-center justify-between gap-3">
                <div>
                  <div className="text-xs font-black uppercase tracking-wider text-primary-orange">
                    4 trung tâm tại Đà Nẵng
                  </div>
                  <div className="text-sm font-semibold text-text-muted">
                    Chọn cơ sở thuận tiện cho lịch học của con
                  </div>
                </div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {locations.map((loc, idx) => {
                  const Icon = centerIcons[idx] ?? MapPin
                  return (
                    <div
                      key={loc.id}
                      className="rounded-2xl border border-primary-orange/20 bg-orange-50/45 p-3 shadow-sm"
                    >
                      <div className="mb-1 flex items-center gap-2">
                        ...
                        <span className="text-sm font-black leading-tight text-text-dark">{loc.name}</span>
                      </div>
                      <p className="pl-10 text-xs font-semibold leading-relaxed text-text-muted">{loc.address}</p>
                    </div>
                  )
                })}
              </div>
