...
export function InternalAwards() {
  return (
        ...
        <div className="mb-8 text-center sm:mb-14">
          ...
          <h2 className="heading-2 mb-4">
            ...
            <span className="text-gradient-orange-purple">
              36.000.000đ giải thưởng mỗi năm
            </span>
          </h2>
                  ...
                  >
                    <td className="px-3 py-3 sm:px-6 sm:py-4">
                      <div className="flex items-center gap-2">
                        <span className="text-xl sm:text-3xl" aria-hidden>{p.icon}</span>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-text-dark sm:text-base">
                Đây là <strong className="text-primary-orange">minh chứng</strong> cho cách Sata Robo
                tạo động lực học tập và thuyết trình đều đặn cho con.
              </p>
            </div>
          </div>
        </div>
