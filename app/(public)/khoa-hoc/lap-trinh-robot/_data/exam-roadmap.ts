const examDuration = { durationPerSession: '90 phút' } as const

const contestLessons: string[] = [
...
export const examRoadmap: ExamCourse[] = [
  {
    id: 'Sata1',
  ...
  },
  {
    ...
    methods: ['Blended Learning', 'Flipped Classroom', 'Luyện tập theo nhiệm vụ bài thi', 'Tự học có hướng dẫn và kiểm soát'],
    lessons: contestLessons.map(l => l.replace('thi đấu', 'thi đấu cấp THCS')),
    ...examDuration,
  },
  {
    id: 'Combo',
